...
public class TweakTransformerHelper
{
    public static void quenchFireTick(World world, int x, int y, int z, Random rand)
    {
        ...
        if (!Blocks.fire.canPlaceBlockAt(world, x, y, z) ||
                !supported && world.isRaining() && (world.isRainingAt(x, y, z) || world.isRainingAt(x - 1, y, z) || world.isRainingAt(x + 1, y, z) || world.isRainingAt(x, y, z - 1) || world.isRainingAt(x, y, z + 1)))
