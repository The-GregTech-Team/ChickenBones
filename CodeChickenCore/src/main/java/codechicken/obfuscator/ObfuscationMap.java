...
public class ObfuscationMap
{
    ...
    {
        public Map<String, ObfuscationEntry> mcpMap = new HashMap<>();
        public Map<String, ObfuscationEntry> srgMap = new HashMap<>();
        public Map<String, ObfuscationEntry> obfMap = new HashMap<>();
